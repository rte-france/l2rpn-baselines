...
class SAC_ReplayBuffer:
    ...
    def sample(self, batch_size):
        ...
        # and new states
        s_batch, a_batch, m_batch, r_batch, d_batch, s2_batch = list(map(np.array, list(zip(*batch))))
        return s_batch, a_batch, m_batch, r_batch, d_batch, s2_batch
